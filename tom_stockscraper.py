...
driver = webdriver.Chrome("C:/Users/Matt/Dropbox/stockwebscraper/chromedriver")
...
try:
    getResults(yesterday, "Pre")
except:
    error = open("error_" + str(yesterday) + ".txt", "a")

try:
    getResults(two_days_ago, "Post")
except:
